...
def model(v0=0.3, k0=0.3, cmu=0.01, Sr0=100, st0=13, d0=4, mu0=10):
    ...
    cmu : float
       Initial continous fase viscosity [-]
    Sr0 : float
       Initial shear rate [-] 
    ...
    Nca0 = 1e-4*cmu*d0*Sr0/(2*st0)                                                  # Capilarity number iniialization
    ...
    m.dD = pe.Var(initialize=d0, bounds=(0.5,100))    # Dropplet size [1e-6 m]
...
def oldroyd_viscosity_model(v0=0.1, k0=0.3, cmu=0.01, Sr0=100,st0=13, d0=4, mu0=10):

    """
    Initializes oldryod viscosity model
    ...
    results = opt.solve(m)        # Initialize
