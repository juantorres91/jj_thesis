...
def MoleBlock(SFIL,n=2):

    m=ConcreteModel()   #Surfactant Mixture
    g=Block()           #Representation block
    
    m.S=RangeSet(1,n)   #Number of surfactant compounds
