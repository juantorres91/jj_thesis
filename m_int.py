...
con_file='/home/juan/Desktop/Tesis/Rheology/Cont.dat'
dis_file='/home/juan/Desktop/Tesis/Rheology/Disp.dat'
surf_file='/home/juan/Desktop/Tesis/Molecular/InputTable.xlsx'
pref_file='/home/juan/Desktop/Tesis/Preference/pref.dat'
...
#Preference block
m.pref=pref_model(pref_file)                           #Preference block integration
...
m.Hum=Var(domain=PositiveReals, bounds=(1, 4))  #Total humectant mass
m.Ocl=Var(domain=PositiveReals, bounds=(0.1,  10))  #Total oclusive mass
m.Emo=Var(domain=PositiveReals, bounds=(1, 4))  #Total emolient mass
...
m.Pro1=Var(domain=Reals, initialize=m.Price.value*m.Dem.value) #Total profit
m.Pro2=Var(domain=Reals, initialize=-m.Cost.value*m.Dem.value)
...
m.dD.pprint()
m.Cdymu.pprint()
m.surf.blo[1].NB.pprint()
m.surf.blo[1].N.pprint()
